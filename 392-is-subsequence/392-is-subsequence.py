class Solution:
    def isSubsequence(self, s: str, t: str) -> bool:
        ...
        n = len(s) #length of s
        m = len(t) #length of t
        while 0<n-j<=m-i: #j<n checks that we are within s, while n-j<=m-i checks that there are more characters left to check than we have characters left to find
